...
public class DrawVisitor extends ASTVisitor {
    ...
    public void draw(String s, AST t) {
        ...
        // ((width/nCount[depth])) 
        //  x value needs tobe calculated considering progress[depth] and nCount[depth] and relative hstep.
        ...
        // Think what shoulw be startx and start y
    ...
    @Override
    public Object visitCharTypeTree(AST t) { draw("CharTypeTree: ",t); return null;}
